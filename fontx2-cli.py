...
def main():
	...
	parser.add_argument('--start_char', help='ONLY USED FOR NEW FONT. Starting char. (default: 32)', type=int, default=32)
	parser.add_argument('--stop_char', help='ONLY USED FOR NEW FONT. Stopping char. (default: 127)', type=int, default=127)
	parser.add_argument('--width', help='ONLY USED FOR NEW FONT. Font width. (default: 16)', type=int, default=16)
	parser.add_argument('--height', help='ONLY USED FOR NEW FONT. Font height. (default: 16)', type=int, default=16)
	...
	if args.from_binary != None:
		...
		exit(1)
	print(f'Imported {font_in.chars_number} chars with size {font_in.width}x{font_in.height}.')
